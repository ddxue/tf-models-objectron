...
# ==============================================================================
"""Train a EfficientNets on Objectron on TPU."""
...
from efficientnet import objectron_input
from efficientnet import model_builder_factory
...
flags.DEFINE_string(
    'data_dir', default='/home/dxue/datasets/objectron/shoe/',
    help=('The directory where the Objectron input data is stored. Please see'
...
def _select_tables_from_flags():
  ...
  column_qualifier = _verify_non_empty_string(FLAGS.bigtable_column_qualifier,
                                              'column_qualifier')
  return [
      objectron_input.BigtableSelection(  # pylint: disable=g-complex-comprehension
          project=project,
          instance=instance,
          table=table,
          prefix=p,
...
def export(est, export_dir, input_image_size=None):
  ...
  if (FLAGS.model_name.startswith('efficientnet-lite')):
    ...
    resize_method = None
  image_serving_input_fn = objectron_input.build_image_serving_input_fn(
...
def main(unused_argv):
  ...
  if FLAGS.mode == 'eval':
    ...
    for ckpt in tf.train.checkpoints_iterator(
      ...
      try:
        ...
        eval_results = est.evaluate(
            input_fn=objectron_eval.input_fn,
            steps=eval_steps,
    ...
    if FLAGS.mode == 'train':
      ...
      est.train(
          input_fn=objectron_train.input_fn,
      ...
      while current_step < FLAGS.train_steps:
        ...
        next_checkpoint = min(current_step + FLAGS.steps_per_eval,
                              FLAGS.train_steps)
        est.train(input_fn=objectron_train.input_fn, max_steps=next_checkpoint)
